...
st.set_page_config(page_title="Spring Stretch Solver", layout="centered")
...
if denominator_trig == 0:
    ...
    if inside_sqrt < 0:
        ...
        # Result
st.markdown(f"<h2 style='text-align: center;'>Strech the spring to a lenth of x = {x:.6f}m</h2>", unsafe_allow_html=True)
